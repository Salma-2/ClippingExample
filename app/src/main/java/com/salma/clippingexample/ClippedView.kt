package com.salma.clippingexample
...
class ClippedView @JvmOverloads constructor(
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        ...
        //  draw text aligned with the right edge of the clipping rectangle.
    ...
    /*
     * allows you to check whether a specified rectangle or path would lie completely outside the currently visible regions, after all transformations have been applied
